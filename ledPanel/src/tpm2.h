...
//Port for TPM2.Net communication
#define TPM2_NET_PORT						50200
...
//Header & footer size
#define TPM2_SER_HEADER_SIZE				0x04 // Header size of a TMP2.Serial packet
#define TPM2_NET_HEADER_SIZE				0x06 // Header size of a TMP2.Net packet
